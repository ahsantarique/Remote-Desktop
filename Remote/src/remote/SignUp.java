...
public class SignUp extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (pass2.equals(pass1)) {
            //if(successfull)
            try {
                sendInfo(user, pass1, "2");
                String res = readResponse();
                if (res.equals("1")) {
                    JOptionPane.showMessageDialog(jButton1, "Team Created Successfully");

                    //this will be used in server
                    //String teamFile = "C:/Users/User/Desktop/" + user + ".txt";

                    /*PrintWriter out1 = new PrintWriter(new BufferedWriter(*///new FileWriter(teamFile, true)/*));*/;
                ...
                /*PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("C:/Users/User/Desktop/team.txt", true)));
                    ...
                    JOptionPane.showMessageDialog(jButton1, "Team Already Exists! Choose Another Name");
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
        } else {
            JOptionPane.showMessageDialog(jButton1, "Passwords Don't match!");
        }
        setVisible(false);
